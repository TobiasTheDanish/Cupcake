...
public class ConnectionPool {
    ...
    private static String USER = "skr_dk";
    private static String PASSWORD = "2dRk9cHFwEBzDGyeg35p";
    private static String URL = "jdbc:mysql://mysql14.unoeuro.com:3306/skr_dk_db";
